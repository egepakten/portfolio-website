...
const About = () => {
  ...
  const terminalLines = [
    ...
    "",
    "$ cat bio.txt",
    "> Computer Science graduate from King's College London specializing in cloud engineering and full-stack development.",
    "> After working as a Frontend Developer at Strand Analytica,",
    "> I discovered my passion for cloud architecture and DevOps.",
